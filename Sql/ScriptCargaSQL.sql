...
INSERT INTO `categories` (`id`,`name`) VALUES (1,'Pizzas');
INSERT INTO `categories` (`id`,`name`) VALUES (2,'Bebidas Alcoholicas');
INSERT INTO `categories` (`id`,`name`) VALUES (3,'Bebidas Sin Alcohol');
INSERT INTO `categories` (`id`,`name`) VALUES (4,'Ensaladas');

--Inserto subcategorías de productos
INSERT INTO `subcategories` (`id`,`name`,`category_id`) VALUES (1,'Con gas',3);
INSERT INTO `subcategories` (`id`,`name`,`category_id`) VALUES (2,'Sin gas',3);
INSERT INTO `subcategories` (`id`,`name`,`category_id`) VALUES (3,'Pizzetas',1);
INSERT INTO `subcategories` (`id`,`name`,`category_id`) VALUES (4,'Fernet',2);
INSERT INTO `subcategories` (`id`,`name`,`category_id`) VALUES (5,'Cocteles',2);
INSERT INTO `subcategories` (`id`,`name`,`category_id`) VALUES (6,'Con carne',4);
INSERT INTO `subcategories` (`id`,`name`,`category_id`) VALUES (7,'Sin carne',4);
...
INSERT INTO `fproducts` (`id`,`name`,`subcategory_id`,`removed`,`sell_price`,`belong`) VALUES (3,'Pizzeta sin queso',1,0,35,'Cocina');
INSERT INTO `fproducts` (`id`,`name`,`subcategory_id`,`removed`,`sell_price`,`belong`) VALUES (4,'Fernet con Coca',2,0,100,'Bar');
INSERT INTO `fproducts` (`id`,`name`,`subcategory_id`,`removed`,`sell_price`,`belong`) VALUES (3,'Pizzeta con Salsa',1,0,23,'Cocina');
INSERT INTO `fproducts` (`id`,`name`,`subcategory_id`,`removed`,`sell_price`,`belong`) VALUES (3,'Combo pizza',1,0,40,'Cocina');
