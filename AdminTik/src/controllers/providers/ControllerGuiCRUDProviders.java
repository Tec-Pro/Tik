...
public class ControllerGuiCRUDProviders implements ActionListener {
    ...
    public ControllerGuiCRUDProviders(GuiCRUDProviders guiCProv, GuiNewProvider guiNProv, GuiProviderCurrentAccount guiPCA,
        ...
        this.controllerGuiNewProvider = new ControllerGuiNewProvider(this.guiNewProvider, guiPCA, this.provider, this.providerCategory);
