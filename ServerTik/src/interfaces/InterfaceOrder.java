...
public interface InterfaceOrder extends Remote{
    ...
    /**Dada una lista de ID de productos a realizarse en un pedido, este metodo los marca como
     * realizados (done = true).
     *
     * @param idOrder id del Pedido
     * @param productsList lista de Integers ID de productos a marcar como realizados
