...
public class ControllerGuiOrderDetails implements ActionListener {
    ...
    private GuiBarOrderDetails guiOrderDetails;
    private Pair<Map<String,Object>,List<Map>> order;
    private Boolean removeThisPane;

    public ControllerGuiOrderDetails(GuiBarOrderDetails guiOrderD, Pair<Map<String,Object>,List<Map>> order) throws RemoteException, NotBoundException {
